namespace Evergine.Bindings.Vulkan
{
	public static partial class VulkanNative
	{
		...
		public const uint VK_DATA_GRAPH_MODEL_TOOLCHAIN_VERSION_LENGTH_QCOM = 3;
		...
		public const uint VK_MAX_DATA_GRAPH_TOSA_NAME_SIZE_ARM = 128;
		public const uint VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM = 4;
		...
		public const uint VK_NVX_IMAGE_VIEW_HANDLE_SPEC_VERSION = 4;
		...
		public const string VK_AMD_GPA_INTERFACE_EXTENSION_NAME = "VK_AMD_gpa_interface";
		...
		public const uint VK_EXT_DESCRIPTOR_HEAP_SPEC_VERSION = 1;
		public const string VK_EXT_DESCRIPTOR_HEAP_EXTENSION_NAME = "VK_EXT_descriptor_heap";
		...
		public const string VK_QCOM_COOPERATIVE_MATRIX_CONVERSION_EXTENSION_NAME = "VK_QCOM_cooperative_matrix_conversion";
		public const uint VK_QCOM_ELAPSED_TIMER_QUERY_SPEC_VERSION = 1;
		public const string VK_QCOM_ELAPSED_TIMER_QUERY_EXTENSION_NAME = "VK_QCOM_elapsed_timer_query";
		...
		public const uint VK_EXT_PRESENT_TIMING_SPEC_VERSION = 3;
		public const string VK_EXT_PRESENT_TIMING_EXTENSION_NAME = "VK_EXT_present_timing";
		...
		public const uint VK_EXT_FRAGMENT_DENSITY_MAP_SPEC_VERSION = 3;
		...
		public const uint VK_EXT_TEXTURE_COMPRESSION_ASTC_3D_SPEC_VERSION = 1;
		public const string VK_EXT_TEXTURE_COMPRESSION_ASTC_3D_EXTENSION_NAME = "VK_EXT_texture_compression_astc_3d";
		...
		public const string VK_QCOM_QUEUE_PERF_HINT_EXTENSION_NAME = "VK_QCOM_queue_perf_hint";
		public const uint VK_QCOM_IMAGE_PROCESSING_3_SPEC_VERSION = 1;
		public const string VK_QCOM_IMAGE_PROCESSING_3_EXTENSION_NAME = "VK_QCOM_image_processing3";
		public const uint VK_QCOM_SHADER_MULTIPLE_WAIT_QUEUES_SPEC_VERSION = 1;
		public const string VK_QCOM_SHADER_MULTIPLE_WAIT_QUEUES_EXTENSION_NAME = "VK_QCOM_shader_multiple_wait_queues";
		public const uint VK_EXT_SHADER_SPLIT_BARRIER_SPEC_VERSION = 1;
		public const string VK_EXT_SHADER_SPLIT_BARRIER_EXTENSION_NAME = "VK_EXT_shader_split_barrier";
		...
		public const uint VK_ARM_SCHEDULING_CONTROLS_SPEC_VERSION = 2;
		...
		public const uint VK_OHOS_EXTERNAL_MEMORY_SPEC_VERSION = 1;
		public const string VK_OHOS_EXTERNAL_MEMORY_EXTENSION_NAME = "VK_OHOS_external_memory";
		...
		public const uint VK_ARM_TENSORS_SPEC_VERSION = 2;
		public const string VK_ARM_TENSORS_EXTENSION_NAME = "VK_ARM_tensors";
		...
		public const string VK_KHR_PRESENT_WAIT_2_EXTENSION_NAME = "VK_KHR_present_wait2";
		...
		public const uint VK_ARM_DATA_GRAPH_SPEC_VERSION = 1;
		public const string VK_ARM_DATA_GRAPH_EXTENSION_NAME = "VK_ARM_data_graph";
		public const uint VK_ARM_DATA_GRAPH_INSTRUCTION_SET_TOSA_SPEC_VERSION = 1;
		public const string VK_ARM_DATA_GRAPH_INSTRUCTION_SET_TOSA_EXTENSION_NAME = "VK_ARM_data_graph_instruction_set_tosa";
		...
		public const uint VK_KHR_VIDEO_DECODE_VP9_SPEC_VERSION = 1;
		public const string VK_KHR_VIDEO_DECODE_VP9_EXTENSION_NAME = "VK_KHR_video_decode_vp9";
		...
		public const uint VK_KHR_UNIFIED_IMAGE_LAYOUTS_SPEC_VERSION = 1;
		public const string VK_KHR_UNIFIED_IMAGE_LAYOUTS_EXTENSION_NAME = "VK_KHR_unified_image_layouts";
		...
		public const uint VK_EXT_MEMORY_DECOMPRESSION_SPEC_VERSION = 1;
		public const string VK_EXT_MEMORY_DECOMPRESSION_EXTENSION_NAME = "VK_EXT_memory_decompression";
		...
		public const string VK_ARM_TENSOR_CONTROLS_EXTENSION_NAME = "VK_ARM_tensor_controls";
		public const uint VK_EXT_SHADER_FLOAT8_SPEC_VERSION = 1;
		...
		public const uint VK_NV_PUSH_CONSTANT_BANK_SPEC_VERSION = 1;
		public const string VK_NV_PUSH_CONSTANT_BANK_EXTENSION_NAME = "VK_NV_push_constant_bank";
		public const uint VK_EXT_RAY_TRACING_INVOCATION_REORDER_SPEC_VERSION = 2;
		public const string VK_EXT_RAY_TRACING_INVOCATION_REORDER_EXTENSION_NAME = "VK_EXT_ray_tracing_invocation_reorder";
		...
		public const string VK_KHR_MAINTENANCE_9_EXTENSION_NAME = "VK_KHR_maintenance9";
		...
		public const uint VK_OHOS_SURFACE_SPEC_VERSION = 1;
		public const string VK_OHOS_SURFACE_EXTENSION_NAME = "VK_OHOS_surface";
		...
		public const string VK_KHR_VIDEO_ENCODE_FEEDBACK_2_EXTENSION_NAME = "VK_KHR_video_encode_feedback2";
		public const uint VK_IMG_FILTER_LINEAR_2D_SPEC_VERSION = 1;
		public const string VK_IMG_FILTER_LINEAR_2D_EXTENSION_NAME = "VK_IMG_filter_linear_2d";
		...
		public const uint VK_ARM_PERFORMANCE_COUNTERS_BY_REGION_SPEC_VERSION = 1;
		public const string VK_ARM_PERFORMANCE_COUNTERS_BY_REGION_EXTENSION_NAME = "VK_ARM_performance_counters_by_region";
		public const uint VK_ARM_SHADER_INSTRUMENTATION_SPEC_VERSION = 1;
		public const string VK_ARM_SHADER_INSTRUMENTATION_EXTENSION_NAME = "VK_ARM_shader_instrumentation";
		...
		public const uint VK_VALVE_FRAGMENT_DENSITY_MAP_LAYERED_SPEC_VERSION = 1;
		public const string VK_VALVE_FRAGMENT_DENSITY_MAP_LAYERED_EXTENSION_NAME = "VK_VALVE_fragment_density_map_layered";
		...
		public const string VK_EXT_MULTISAMPLED_RENDER_TO_SWAPCHAIN_EXTENSION_NAME = "VK_EXT_multisampled_render_to_swapchain";
		...
		public const string VK_KHR_OPACITY_MICROMAP_EXTENSION_NAME = "VK_KHR_opacity_micromap";
		public const uint VK_EXT_SHADER_64BIT_INDEXING_SPEC_VERSION = 1;
		public const string VK_EXT_SHADER_64BIT_INDEXING_EXTENSION_NAME = "VK_EXT_shader_64bit_indexing";
		public const uint VK_EXT_CUSTOM_RESOLVE_SPEC_VERSION = 1;
		public const string VK_EXT_CUSTOM_RESOLVE_EXTENSION_NAME = "VK_EXT_custom_resolve";
		public const uint VK_QCOM_DATA_GRAPH_MODEL_SPEC_VERSION = 1;
		public const string VK_QCOM_DATA_GRAPH_MODEL_EXTENSION_NAME = "VK_QCOM_data_graph_model";
		public const uint VK_KHR_MAINTENANCE_10_SPEC_VERSION = 1;
		public const string VK_KHR_MAINTENANCE_10_EXTENSION_NAME = "VK_KHR_maintenance10";
		public const uint VK_ARM_DATA_GRAPH_OPTICAL_FLOW_SPEC_VERSION = 1;
		public const string VK_ARM_DATA_GRAPH_OPTICAL_FLOW_EXTENSION_NAME = "VK_ARM_data_graph_optical_flow";
		public const uint VK_EXT_SHADER_LONG_VECTOR_SPEC_VERSION = 1;
		public const string VK_EXT_SHADER_LONG_VECTOR_EXTENSION_NAME = "VK_EXT_shader_long_vector";
		...
		public const uint VK_EXT_SHADER_UNIFORM_BUFFER_UNSIZED_ARRAY_SPEC_VERSION = 1;
		...
		public const string VK_SEC_UBM_SURFACE_EXTENSION_NAME = "VK_SEC_ubm_surface";
		public const uint VK_KHR_EXTENDED_FLAGS_SPEC_VERSION = 1;
		public const string VK_KHR_EXTENDED_FLAGS_EXTENSION_NAME = "VK_KHR_extended_flags";
		public const uint VK_EXT_SHADER_OCP_MICROSCALING_TYPES_SPEC_VERSION = 1;
		public const string VK_EXT_SHADER_OCP_MICROSCALING_TYPES_EXTENSION_NAME = "VK_EXT_shader_ocp_microscaling_types";
		public const uint VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_SPEC_VERSION = 1;
		public const string VK_VALVE_SHADER_MIXED_FLOAT_DOT_PRODUCT_EXTENSION_NAME = "VK_VALVE_shader_mixed_float_dot_product";
		public const uint VK_SEC_THROTTLE_HINT_SPEC_VERSION = 1;
		public const string VK_SEC_THROTTLE_HINT_EXTENSION_NAME = "VK_SEC_throttle_hint";
		public const uint VK_ARM_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_SPEC_VERSION = 1;
		public const string VK_ARM_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_EXTENSION_NAME = "VK_ARM_data_graph_neural_accelerator_statistics";
		public const uint VK_EXT_PRIMITIVE_RESTART_INDEX_SPEC_VERSION = 1;
		public const string VK_EXT_PRIMITIVE_RESTART_INDEX_EXTENSION_NAME = "VK_EXT_primitive_restart_index";
