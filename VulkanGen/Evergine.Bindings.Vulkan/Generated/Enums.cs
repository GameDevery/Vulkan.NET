...
namespace Evergine.Bindings.Vulkan
{
	...
	{
		None = 0,
		VK_IMAGE_USAGE_2_TRANSFER_SRC_BIT_KHR = 1,
		VK_IMAGE_USAGE_2_TRANSFER_DST_BIT_KHR = 2,
		VK_IMAGE_USAGE_2_SAMPLED_BIT_KHR = 4,
		VK_IMAGE_USAGE_2_STORAGE_BIT_KHR = 8,
		VK_IMAGE_USAGE_2_COLOR_ATTACHMENT_BIT_KHR = 16,
		VK_IMAGE_USAGE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR = 32,
		VK_IMAGE_USAGE_2_TRANSIENT_ATTACHMENT_BIT_KHR = 64,
		VK_IMAGE_USAGE_2_INPUT_ATTACHMENT_BIT_KHR = 128,
		VK_IMAGE_USAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR = 256,
		VK_IMAGE_USAGE_2_FRAGMENT_DENSITY_MAP_BIT_EXT = 512,
		VK_IMAGE_USAGE_2_VIDEO_DECODE_DST_BIT_KHR = 1024,
		VK_IMAGE_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR = 2048,
		VK_IMAGE_USAGE_2_VIDEO_DECODE_DPB_BIT_KHR = 4096,
		VK_IMAGE_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR = 8192,
		VK_IMAGE_USAGE_2_VIDEO_ENCODE_SRC_BIT_KHR = 16384,
		VK_IMAGE_USAGE_2_VIDEO_ENCODE_DPB_BIT_KHR = 32768,
		VK_IMAGE_USAGE_2_INVOCATION_MASK_BIT_HUAWEI = 262144,
		VK_IMAGE_USAGE_2_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT = 524288,
		VK_IMAGE_USAGE_2_SAMPLE_WEIGHT_BIT_QCOM = 1048576,
		VK_IMAGE_USAGE_2_SAMPLE_BLOCK_MATCH_BIT_QCOM = 2097152,
		VK_IMAGE_USAGE_2_HOST_TRANSFER_BIT_KHR = 4194304,
		VK_IMAGE_USAGE_2_TENSOR_ALIASING_BIT_ARM = 8388608,
		VK_IMAGE_USAGE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR = 33554432,
		VK_IMAGE_USAGE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR = 67108864,
		VK_IMAGE_USAGE_2_TILE_MEMORY_BIT_QCOM = 134217728,
	}
	...
	public enum VkImageCreateFlags
	{
		...
		VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR = 4194304,
	}
	...
	{
		None = 0,
		VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR = 1,
		VK_IMAGE_CREATE_2_SPARSE_RESIDENCY_BIT_KHR = 2,
		VK_IMAGE_CREATE_2_SPARSE_ALIASED_BIT_KHR = 4,
		VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR = 8,
		VK_IMAGE_CREATE_2_CUBE_COMPATIBLE_BIT_KHR = 16,
		VK_IMAGE_CREATE_2_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR = 4194304,
		VK_IMAGE_CREATE_2_2D_ARRAY_COMPATIBLE_BIT_KHR = 32,
		VK_IMAGE_CREATE_2_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR = 64,
		VK_IMAGE_CREATE_2_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR = 128,
		VK_IMAGE_CREATE_2_EXTENDED_USAGE_BIT_KHR = 256,
		VK_IMAGE_CREATE_2_DISJOINT_BIT_KHR = 512,
		VK_IMAGE_CREATE_2_ALIAS_BIT_KHR = 1024,
		VK_IMAGE_CREATE_2_PROTECTED_BIT_KHR = 2048,
		VK_IMAGE_CREATE_2_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT = 4096,
		VK_IMAGE_CREATE_2_CORNER_SAMPLED_BIT_NV = 8192,
		VK_IMAGE_CREATE_2_SUBSAMPLED_BIT_EXT = 16384,
		VK_IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT = 32768,
		VK_IMAGE_CREATE_2_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT = 65536,
		VK_IMAGE_CREATE_2_2D_VIEW_COMPATIBLE_BIT_EXT = 131072,
		VK_IMAGE_CREATE_2_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT = 262144,
		VK_IMAGE_CREATE_2_VIDEO_PROFILE_INDEPENDENT_BIT_KHR = 1048576,
	}
	...
	public enum VkPipelineCreateFlags
	{
		...
		VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR = 16777216,
	}
	...
	public enum VkPipelineCreateFlags2 : ulong
	{
		...
		VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR = 16777216,
		VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR = 2199023255552,
	...
	{
		None = 0,
		VK_PRIVATE_DATA_SLOT_CREATE_BASE_OBJECT_HANDLE_BIT_NV = 1,
	}
	...
	public enum VkSwapchainCreateFlagsKHR
	{
		...
		VK_SWAPCHAIN_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT = 256,
	}
	...
	public enum VkGeometryInstanceFlagsKHR
	{
		...
		VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR = 16,
		VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR = 32,
	}
	...
	public enum VkBuildAccelerationStructureFlagsKHR
	{
		...
		VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_KHR = 64,
		VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_KHR = 128,
		VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR = 1024,
	}
	...
	public enum VkPipelineLayoutCreateFlags
	{
		...
		VK_PIPELINE_LAYOUT_CREATE_NO_TASK_SHADER_BIT_KHR = 4,
	}
	...
	[Flags]
	public enum VkRenderingAttachmentFlagsKHR
	{
		None = 0,
	...
	[Flags]
	public enum VkResolveImageFlagsKHR
	{
		None = 0,
	...
	public enum VkPhysicalDeviceSchedulingControlsFlagsARM : ulong
	{
		...
		VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_ARM = 2,
	}

	[Flags]
	public enum VkPresentStageFlagsEXT
	{
		None = 0,
	...
	[Flags]
	public enum VkPastPresentationTimingFlagsEXT
	{
		None = 0,
	...
	[Flags]
	public enum VkPresentTimingInfoFlagsEXT
	{
		None = 0,
	...
	{
		None = 0,
		VK_COOPERATIVE_MATRIX_SATURATING_ACCUMULATION_BIT_EXT = 1,
	}
	...
	public enum VkVideoEncodeFeedbackFlagsKHR
	{
		...
		VK_VIDEO_ENCODE_FEEDBACK_AVERAGE_QUANTIZATION_BIT_KHR = 8,
		VK_VIDEO_ENCODE_FEEDBACK_MIN_QUANTIZATION_BIT_KHR = 16,
		VK_VIDEO_ENCODE_FEEDBACK_MAX_QUANTIZATION_BIT_KHR = 32,
		VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR = 64,
		VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR = 128,
		VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR = 256,
		VK_VIDEO_ENCODE_FEEDBACK_PICTURE_PARTITION_COUNT_BIT_KHR = 512,
	}
	...
	{
		None = 0,
		VK_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_STATUS_BIT_KHR = 1,
		VK_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_BITSTREAM_BUFFER_OFFSET_BIT_KHR = 2,
		VK_VIDEO_ENCODE_PER_PARTITION_FEEDBACK_BITSTREAM_BYTES_WRITTEN_BIT_KHR = 4,
	}
	...
	public enum VkFormatFeatureFlags2 : ulong
	{
		...
		VK_FORMAT_FEATURE_2_HOST_IMAGE_TRANSFER_BIT = 70368744177664,
		...
		VK_FORMAT_FEATURE_2_BLOCK_MATCHING_SXD_BIT_QCOM = 17592186044416,
		...
		VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_2D_BIT_IMG = 35184372088832,
		...
		VK_FORMAT_FEATURE_2_DATA_GRAPH_OPTICAL_FLOW_IMAGE_BIT_ARM = 72057594037927936,
		VK_FORMAT_FEATURE_2_DATA_GRAPH_OPTICAL_FLOW_VECTOR_BIT_ARM = 144115188075855872,
		VK_FORMAT_FEATURE_2_DATA_GRAPH_OPTICAL_FLOW_COST_BIT_ARM = 288230376151711744,
	}

	[Flags]
	public enum VkFormatFeatureFlags4KHR : ulong
	{
		None = 0,
	}
	...
	[Flags]
	public enum VkDeviceFaultFlagsKHR
	{
		None = 0,
	...
	public enum VkDeviceFaultVendorBinaryHeaderVersionKHR
	{
		VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_KHR = 1,
		VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_EXT = 0,
	}
	...
	public enum VkShaderCreateFlagsEXT
	{
		...
		VK_SHADER_CREATE_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_EXT = 4096,
		VK_SHADER_CREATE_64_BIT_INDEXING_BIT_EXT = 32768,
		VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR = 262144,
	}
	...
	[Flags]
	public enum VkAddressCopyFlagsKHR
	{
		None = 0,
	...
	public enum VkDataGraphPipelineSessionCreateFlagsARM : ulong
	{
		...
		VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_OPTICAL_FLOW_CACHE_BIT_ARM = 2,
	}
	...
	[Flags]
	public enum VkDataGraphPipelineDispatchFlagsARM : ulong
	{
		None = 0,
	}
	...
	public enum VkPerfHintTypeQCOM
	{
	...
	[Flags]
	public enum VkSwapchainImageUsageFlagsOHOS
	{
		None = 0,
	...
	[Flags]
	public enum VkSpirvResourceTypeFlagsEXT
	{
		None = 0,
		VK_SPIRV_RESOURCE_TYPE_ALL_EXT = 2147483647,
	...
	{
		None = 0,
		VK_GPA_SQ_SHADER_STAGE_PS_BIT_AMD = 1,
		VK_GPA_SQ_SHADER_STAGE_VS_BIT_AMD = 2,
		VK_GPA_SQ_SHADER_STAGE_GS_BIT_AMD = 4,
		VK_GPA_SQ_SHADER_STAGE_ES_BIT_AMD = 8,
		VK_GPA_SQ_SHADER_STAGE_HS_BIT_AMD = 16,
		VK_GPA_SQ_SHADER_STAGE_LS_BIT_AMD = 32,
		VK_GPA_SQ_SHADER_STAGE_CS_BIT_AMD = 64,
	}
	...
	public enum VkGpaPerfBlockAMD
	{
		...
		VK_GPA_PERF_BLOCK_RLCLOCAL_AMD = 0,
	}
	...
	[Flags]
	public enum VkAddressCommandFlagsKHR
	{
		None = 0,
		VK_ADDRESS_COMMAND_PROTECTED_BIT_KHR = 1,
		VK_ADDRESS_COMMAND_FULLY_BOUND_BIT_KHR = 2,
		VK_ADDRESS_COMMAND_STORAGE_BUFFER_USAGE_BIT_KHR = 4,
		VK_ADDRESS_COMMAND_UNKNOWN_STORAGE_BUFFER_USAGE_BIT_KHR = 8,
		VK_ADDRESS_COMMAND_TRANSFORM_FEEDBACK_BUFFER_USAGE_BIT_KHR = 16,
		VK_ADDRESS_COMMAND_UNKNOWN_TRANSFORM_FEEDBACK_BUFFER_USAGE_BIT_KHR = 32,
	}

	[Flags]
	public enum VkDataGraphTOSAQualityFlagsARM
	{
		None = 0,
		VK_DATA_GRAPH_TOSA_QUALITY_ACCELERATED_ARM = 1,
		VK_DATA_GRAPH_TOSA_QUALITY_CONFORMANT_ARM = 2,
		VK_DATA_GRAPH_TOSA_QUALITY_EXPERIMENTAL_ARM = 4,
		VK_DATA_GRAPH_TOSA_QUALITY_DEPRECATED_ARM = 8,
	}
	...
	[Flags]
	public enum VkDataGraphOpticalFlowGridSizeFlagsARM
	{
		VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_UNKNOWN_ARM = 0,
		VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_1X1_BIT_ARM = 1,
		VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_2X2_BIT_ARM = 2,
		VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_4X4_BIT_ARM = 4,
		VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_8X8_BIT_ARM = 8,
	}

	[Flags]
	public enum VkDataGraphOpticalFlowImageUsageFlagsARM
	{
		VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_UNKNOWN_ARM = 0,
		VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_INPUT_BIT_ARM = 1,
		VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_OUTPUT_BIT_ARM = 2,
		VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_HINT_BIT_ARM = 4,
		VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_COST_BIT_ARM = 8,
	}

	public enum VkDataGraphOpticalFlowPerformanceLevelARM
	{
	...
	public enum VkDataGraphPipelineNodeConnectionTypeARM
	{
		None = 0,
	...
	[Flags]
	public enum VkDataGraphOpticalFlowCreateFlagsARM
	{
		None = 0,
		VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_HINT_BIT_ARM = 1,
		VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_COST_BIT_ARM = 2,
		VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_RESERVED_30_BIT_ARM = 1073741824,
	}

	[Flags]
	public enum VkDataGraphOpticalFlowExecuteFlagsARM
	{
		None = 0,
		VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_DISABLE_TEMPORAL_HINTS_BIT_ARM = 1,
		VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_UNCHANGED_BIT_ARM = 2,
		VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_UNCHANGED_BIT_ARM = 4,
		VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_IS_PREVIOUS_REFERENCE_BIT_ARM = 8,
		VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_IS_PREVIOUS_INPUT_BIT_ARM = 16,
	}

	public enum VkNeuralAcceleratorStatisticsModeARM
	{
